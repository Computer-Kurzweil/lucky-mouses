package org.woehlke.computer.kurzweil.lucky.mouses.config;
...
public class ComputerKurzweilProperties implements Serializable {
    ...
    public static class LuckyMouses {
        ...
        public static class View {
            ...
            @NotBlank
            private String buttonsRunG;

            @NotBlank
            private String buttonsRunH;

            @NotBlank
            private String buttonsRunI;

            @NotBlank
            private String buttonsRunJ;

            @NotBlank
            private String buttonsRunK;
        }
